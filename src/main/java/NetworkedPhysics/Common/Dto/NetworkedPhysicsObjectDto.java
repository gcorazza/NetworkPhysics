...
public class NetworkedPhysicsObjectDto implements Serializable {
    ...
    public NetworkedPhysicsObjectDto(Shape shape, float a, float b, float c, float mass, float friction, float restitution, ObjectState objectState) {
        this.shape = shape;
        this.a = a;
        this.b = b;
        this.c = c;
    ...
    public NetworkedPhysicsObjectDto(Shape shape, float a, float b, float c, ObjectState objectState) {
        this(shape, a, b, c, 1, 0.5f, 0.5f, objectState);
    }
